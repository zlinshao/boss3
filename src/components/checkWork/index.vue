<template>
  <div>
    <div class="describe_border">
      <span class="count" style="color: #fce14f"> <i class="el-icon-time" style="font-size: 19px"></i> <span
        style="color: #787a7e;margin-right:4px;">迟到</span><span>{{this.late}}</span> 次</span>
      <span class="count" style="color: #6a8dfb"> <i class="el-icons-fa-clock-o" style="font-size: 19px"></i> <span
        style="color: #787a7e;margin-right:4px;">早退</span><span>{{this.early}}</span> 次</span>
      <span class="count" style="color: #fc2c96"> <i class="el-icons-fa-warning"
                                                     style="font-size: 19px;margin-right:12px;"></i><span
        style="color: #787a7e;margin-right:4px;">旷工</span> <span>{{this.absent}}</span> 次</span>
      <span class="count"> <i class="iconfont icon-kaoqin1" style="color: #6a8dfb;font-size:19px"></i> <span
        style="color: #787a7e;margin-right:8px;">出勤天数</span> <span
        style="color: #6a8dfb">{{this.attend}}</span> 天</span>
    </div>
    <calendar
      :events="demoEvents"
