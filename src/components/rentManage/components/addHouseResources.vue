<template>
  <div id="addHouseResources">
    <el-dialog :close-on-click-modal="false" title="登记房源" :visible.sync="addHouseResourcesDialogVisible" width="60%">
      <div>
            ...
            <div class="scroll_bar">
              <el-form label-width="100px">
                <el-form-item label="证件照片" required="">
                  <UpLoad :ID="'addHouse_id_card'" :isClear="isClear" :editImage="identity_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="银行卡照片" required="">
                  <UpLoad :ID="'addHouse_bank_card'" :isClear="isClear" :editImage="bank_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="合同照片" required="">
                  <UpLoad :ID="'addHouse_contract_card'" :isClear="isClear" :editImage="photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="水表照片">
                  <UpLoad :ID="'addHouse_water_card'" :isClear="isClear" :editImage="water_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="电表照片">
                  <UpLoad :ID="'addHouse_ele_card'" :isClear="isClear" :editImage="electricity_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                ...
                <el-form-item label="补充照片">
                  <UpLoad :ID="'addHouse_other_card'" :isClear="isClear" :editImage="other_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
