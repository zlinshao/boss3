<template>
  <div id="decreaseGoods">
      ...
      <div>
        ...
        <el-form size="small" :model="form" label-width="80px">
          <el-form-item label="物品名称" required>
            <el-input type="textarea" v-model="goodScode" :rows="1"
                      @click.native="openModalDialog('changeGoodsDialog')"></el-input>
          </el-form-item>
        </el-form>
    ...
    <ChangeGoodsResources :changeGoodsDialog="changeGoodsDialog" :collectHouseId="collectHouseId"
                          @close="closeChangeGoodsResources" @changeGoodSave="changeGoodSave"></ChangeGoodsResources>
  </div>
</template>
