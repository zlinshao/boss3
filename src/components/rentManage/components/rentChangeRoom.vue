  ...
  <div id="rentChangeRoom">
    <el-dialog title="租客换房" :visible.sync="rentChangeRoomDialogVisible" width="60%">
            ...
            <el-row >
              ...
              <el-col :span="8">
                <el-form-item label="退房性质" required>
                  <el-input :disabled="true">换房</el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
        ...
        <div class="form_border">
          <el-form size="mini" :model="formInline" label-width="80px">
            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="合计欠费">
                  <el-row :gutter="20">
                    <el-col :span="10">
                      <el-input  placeholder="月"></el-input>
                    </el-col>
                    <el-col :span="10">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="small" type="primary" @click="rentChangeRoomDialogVisible = false">确 定</el-button>
      </span>
    </el-dialog>
  </div>
</template>
