            ...
            <div class="scroll_bar">
              <el-form label-width="100px">
                <el-form-item label="证件照片" required="">
                  <UpLoad :ID="'changeRent_id_card'" :isClear="isClear" :editImage="identity_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="合同照片" required="">
                  <UpLoad :ID="'changeRent_contract_card'" :isClear="isClear" :editImage="photo" @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="水表照片">
                  <UpLoad :ID="'changeRent_water_card'" :isClear="isClear" :editImage="water_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="电表照片">
                  <UpLoad :ID="'changeRent_ele_card'" :isClear="isClear" :editImage="electricity_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="燃气表照片">
                  <UpLoad :ID="'changeRent_gas_card'" :isClear="isClear" :editImage="gas_photo" @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="交接单照片">
                  <UpLoad :ID="'changeRent_hand_over_card'" :isClear="isClear" :editImage="checkin_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="截图凭证" required="">
                  <UpLoad :ID="'changeRent_certificate_photo'" :isClear="isClear" :editImage="certificate_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="押金收条" required="">
                  <UpLoad :ID="'changeRent_deposit_card'" :isClear="isClear" :editImage="deposit_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>

                <el-form-item label="补充照片">
                  <UpLoad :ID="'changeRent_other_card'" :isClear="isClear" :editImage="other_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="退租交接单照片">
                  <UpLoad :ID="'changeRent_checkout_card'" :isClear="isClear" :editImage="checkout_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
                <el-form-item label="退租结算照片">
                  <UpLoad :ID="'changeRent_checkout_settle_card'" :isClear="isClear" :editImage="checkout_settle_photo"
                          @getImg="getImg"></UpLoad>
                </el-form-item>
              </el-form>
            </div>
...
//        this.pay_way_bet.splice(item, 1);
      ...
      getImg(val){
        this.isUpPic = val[2];
        if (val[0] === 'changeRent_id_card') {
          this.params.identity_photo = val[1];
        } else if (val[0] === 'changeRent_contract_card') {
          this.params.photo = val[1];
        } else if (val[0] === 'changeRent_water_card') {
          this.params.water_photo = val[1];
        } else if (val[0] === 'changeRent_ele_card') {
          this.params.electricity_photo = val[1];
        } else if (val[0] === 'changeRent_gas_card') {
          this.params.gas_photo = val[1];
        } else if (val[0] === 'changeRent_hand_over_card') {
          this.params.checkin_photo = val[1];
        } else if (val[0] === 'changeRent_certificate_photo') {
          this.params.certificate_photo = val[1];
        } else if (val[0] === 'changeRent_deposit_card') {
          this.params.deposit_photo = val[1];
        } else if (val[0] === 'changeRent_other_card') {
          this.params.other_photo = val[1];
        } else if (val[0] === 'changeRent_checkout_card') {
          this.params.checkout_photo = val[1];
        } else if (val[0] === 'changeRent_checkout_settle_card') {
