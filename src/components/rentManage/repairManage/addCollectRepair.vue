          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="上传照片">
                <!-- <img class="img" v-if="photos" v-for="(item, key) in photos" :src="item"></img> -->
                <UpLoad :ID="'upload_collect'" @getImg="myGetImg" :isClear="isClear" :editImage="photos"></UpLoad>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      personCategory: [],
      cityCategory: [],
      emergencies: [{ id: 1, value: "一般" }, { id: 2, value: "紧急" }],
      isClear: false, //删除照片
      photos: {}, //房屋影像
    };
  },
  ...
  methods: {
    ...
    confirmAdd() {
      this.$http
        .put(globalConfig.server + "repaire/update/" + this.form.id, this.form)
        .then(res => {
