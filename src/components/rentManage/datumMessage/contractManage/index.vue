        ...
        <div class="filter high_grade" :class="isHigh? 'highHide':''">
          <el-form :inline="true" onsubmit="return false" :model="formInline" size="mini" label-width="100px">
            ...
            <div class="btnOperate">
              <el-button type="primary" size="mini" @click="outNumber" v-if="activeName === 'first'">导出</el-button>  
...
<script>
  ...
  export default {
    ...
    methods: {
      outNumber() {
        this.$http.get(globalConfig.server + `lease/collect/count`,{responseType: 'arraybuffer',params: {
