        ...
        <div class="form_border">
          <el-form size="mini" :model="params" label-width="80px">
            <el-row>
              ...
              <el-col :span="4">
                <el-form-item label="其他">
                  <el-input disabled v-model="params.water_other" placeholder="请输入内容"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <div class="content">
            ...
            <el-row>
              ...
              <el-col :span="4">
                <el-form-item label="其他">
                  <el-input disabled v-model="params.electricity_peak_other" placeholder="请输入内容"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <div class="content">
            ...
            <el-row>
              ...
              <el-col :span="4">
                <el-form-item label="其他">
                  <el-input disabled v-model="params.electricity_valley_other" placeholder="请输入内容"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <div class="content">
            ...
            <el-row>
              ...
              <el-col :span="4">
                <el-form-item label="其他">
                  <el-input disabled v-model="params.gas_other" placeholder="请输入内容"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="2" >
                <div class="content">
