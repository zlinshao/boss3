        ...
        <el-col :span="8">
          <div>
            <div class="title" style="color: #7ee8a6;">
              ...
              <div v-if="noticeInfofirst.type == 1"><img @click="openMore(noticeInfofirst)" src="./../assets/images/shenp1.jpg" style="width: 100%;height: 195px;"></div>
              <div v-if="noticeInfofirst.type == 2"><img @click="openMore(noticeInfofirst)" src="./../assets/images/shenp3.jpg" style="width: 100%;height: 195px;"></div>
              <div v-if="noticeInfofirst.type == 3"><img @click="openMore(noticeInfofirst)" src="./../assets/images/shenp2.jpg" style="width: 100%;height: 195px;"></div>
