<template>
  <div>
    <el-dialog title="修改职位" :visible.sync="editOnlyPositionDialogVisible" width="30%">
      <div>
...
<script>
  ...
  export default {
    ...
    methods:{
      //编辑时获取员工信息
      confirmAdd(){
        this.$http.put(globalConfig.server_user+'api/v1/position/type/'+this.onlyPositionId,this.params).then((res) => {
