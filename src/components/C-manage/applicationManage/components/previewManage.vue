  ...
  export default {
    ...
    methods: {
      getTableData() {
        ...
        this.$http.get(globalConfig.server+'api/client/preview-order-list',{params:this.params}).then((res)=>{
      ...
      confirmEdit(){
        this.$http.post(globalConfig.server+'api/client/preview-order-edit',this.editParams).then((res)=>{
          if(res.data.code === '1100200'){
            this.$notify.success({
              title:'成功',
              msg:res.data.msg
