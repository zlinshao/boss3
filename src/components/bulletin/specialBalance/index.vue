<template>
  <div @click="show=false" @contextmenu="closeMenu">
      ...
      <el-form :inline="true" :model="form" size="mini" label-width="80px">
        <el-form-item>
          <el-select v-model="form.status" clearable size="mini">
            <el-option label="收/租状态" value=""></el-option>
    ...
    <SpecialDetail :module="specialVisible" @close="closeSpecial"></SpecialDetail>
  </div>
</template>
...
<script>
  ...
  export default {
    name: "index",
    components: {organization, RightMenu, Remarks, SpecialDetail},
    data() {
      return {
        rightMenuX: 0,
        rightMenuY: 0,
