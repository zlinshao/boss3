        ...
        <el-form :inline="true" :model="form" size="mini" label-width="100px">
          ...
          <el-row class="el_row_border">
            <el-col :span="12">
              <el-row>
                <el-col :span="8">
                  <div class="el_col_label">标记筛选</div>
                </el-col>
          ...
          <el-row class="el_row_border">
            <el-col :span="12">
              <el-row>
                <el-col :span="8">
                  <div class="el_col_label">租房状态</div>
                </el-col>
                <el-col :span="16" class="el_col_option">
                  <el-form-item>
                    <el-select v-model="form.status" clearable size="mini">
                      <el-option label="请选择" value=""></el-option>
                      <el-option v-for="(key,index) in rentValue" :label="key" :value="index + 1" :key="index"></el-option>
                    </el-select>
                  </el-form-item>
                </el-col>
              </el-row>
  ...
  export default {
    ...
    data() {
      return {
        ...
        remarkVisible: false,
        badgeValue: ['炸单', '调房', '款项'],
        rentValue: ['出租', '续租','个人转租','公司转租','未收先祖'],
        form: {
          status: '',
          organize: '',
          dates: '',
