    ...
    methods: {
      ...
      handleEditOk() {
        if (!this.editValue) {
          ...
          this.$http.post(globalConfig.server + `account/allocation/update/${this.currentRow.id}`,{
      ...
      handleEditChange() {
        this.$http.get(globalConfig.server + 'account/manage/index',{
          params: {
            cate: this.editCate,
            all: 1
          }
      ...
      getAccountList() {
        ...
        this.$http
          .get(globalConfig.server + "account/allocation/index", {
            params: this.params
          })
          .then(res => {
            if (res.data.success) {
      ...
      deleteAccount() {
        this.$http.post(globalConfig.server + "account/allocation/delete", {id: this.multipleSelection}).then(res => {
          if (res.data.success) {
            this.$notify.success({
              title: "成功",
      ...
      addAllocation() {
        ...
        this.$http.post(globalConfig.server + 'account/allocation/add',this.formAllocation).then(res => {
          if (res.data.success) {
            this.$notify.success({
              title: '成功',
              message: res.data.message
