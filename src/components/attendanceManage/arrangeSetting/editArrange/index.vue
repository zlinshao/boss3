  ...
  <div id="markInfo">
    ...
    <div style="margin-top:20px">
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <span>姓名：</span>
          <el-input placeholder="请输入" size="mini" style="width:180px;dispaly:inline-block;margin-left:20px;"></el-input>
        </el-col>
        <el-col :span="4">
          <span>部门：</span>
          <el-input placeholder="请输入" size="mini" style="width:180px;dispaly:inline-block;margin-left:20px;"></el-input>
    ...
    <!-- 排班表 可编辑 -->
    <div class="tableInfo">
      <el-table :data="arrangeListData" :header-cell-style="headerCellStyle" @cell-dblclick="dbclickCell" :cell-class-name="rowClass">
    ...
    <div style="margin-top:30px;text-align:right;">
      <el-pagination background :page-sizes="[15,20,25,30]" layout="total,sizes,prev, pager, next ,jumper" :total="1000">
      </el-pagination>
    </div>
