<template>
    <div id="markInfo">
       <div>
            ...
            <el-tag type="success" size="mini">B: 正常班10:00-19:00</el-tag>
            <el-tag type="warning" size="mini">C: 晚班13:00-19:00</el-tag>
           ...
           <el-table-column prop="name" label="姓名" width="80px"></el-table-column>
            ...
            >
                <template slot-scope="scope">
                    <div>
                        <el-button type="primary" size="mini">以此为模板</el-button>
                    </div>
                </template>
            </el-table-column>
           </el-table>
...
export default {
    ...
    created (){
        this.getCurrentMonthDays('2018-10-25');
    },
    mounted (){
