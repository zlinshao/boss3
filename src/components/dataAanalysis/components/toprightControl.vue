<template>
  <div style="position: absolute;top:15px;right: 15px;">
    <el-popover
      ...
      <el-button icon="el-icon-question" slot="reference" circle style="float: right;overflow:hidden;border:1px #409EFF solid;color:#409EFF;" size="mini" type="text"></el-button>
    </el-popover>
