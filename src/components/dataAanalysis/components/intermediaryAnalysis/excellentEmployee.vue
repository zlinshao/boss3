<template>
  <!-- 中介费占业绩比最高前100名员工 -->
  <div id="chartCard" >
    <tableCard :theme="theme" :chartData="chartData"></tableCard>
  </div>
</template>
<script>
  import tableCard from "../../wareHouseData/chart/tableCard.vue"
    export default {
      ...
      data(){
          ...
          chartMsg:{  //图表所需信息
            ...
            id:1,//图表id
            title:'中介费占业绩比最高前100名员工', //标题
            detailMsg:'这是说明。。。。',//说明
            chartType:"table",//类型
            tag:['财务','业务'],//标签
          },
          theme:"中介费占业绩比最高前100名员工",
          jiadata:[{
            area: '南京油坊桥组',
            manager: '王小虎',
