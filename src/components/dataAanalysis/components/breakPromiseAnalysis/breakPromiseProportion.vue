<template>
  <!-- 违约金、滞纳金、炸单已收定金收入 -->
  <div id="chartCard" >
    <pie :chartheight="chartheight" :chartData="chartData" @click.native="detaildialogVisible=true"></pie>
     <el-dialog
...
<script>
  ...
  import pie from "../../wareHouseData/chart/pie.vue"
    export default {
      components:{pie,toprightControl},
      data(){
				return {
          chartData:'',//图表数据
          chartMsg:{  //图表所需信息
