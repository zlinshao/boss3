    ...
    <el-card class="box-card"
      ...
      <div> 
        <div style="width:100%;height:260px;position:relative" @dblclick="detaildialogVisible=true">
          <stackedColumn :chartheight="chartheight"></stackedColumn>
        </div>
      </div>
    </el-card>
     <el-dialog
...
<script>
  ...
  import stackedColumn from "../../chart/stackedColumn.vue"
  import bubblePoint from "../../chart/bubblePoint.vue"
  
    export default {
      components:{stackedPercentageColumn,toprightControl,stackedColumn,bubblePoint},
      data(){
				return {
          theme:"租房炸弹数量、炸单率",
          chartheight:260,
