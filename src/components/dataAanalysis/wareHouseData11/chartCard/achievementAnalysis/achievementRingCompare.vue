    ...
    <el-card class="box-card"
      ...
      <div> 
        <div style="width:100%;height:260px;position:relative" @dblclick="detaildialogVisible=true">
          <groupedColumn :chartheight="chartheight"></groupedColumn>
        </div>
      </div>
    </el-card>
     <el-dialog
      ...
      <div>
        ...
        <div class="detailcontent">
          ...
          <div class="content">
            <groupedColumn :chartheight="chartheightDia"></groupedColumn>
          </div>
        </div>
      </div>
    </el-dialog>
...
<script>
  ...
  import groupedColumn from "../../chart/groupedColumn.vue"
    export default {
