<template>
  <div id="visitRecord">
    <el-dialog :close-on-click-modal="false" title="取消宿舍" :visible.sync="cancelDormDialogVisible" width="30%">
      <div class="">
        <el-form size="mini" onsubmit="return false;" label-width="100px">
          ...
          <el-row>
            <el-form-item label="当前入住人数">
              <el-input v-model="live_num" placeholder="请选择" disabled></el-input>
            </el-form-item>
          </el-row>
          <el-row>
