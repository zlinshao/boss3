      ...
      <el-tabs v-model="activeName" @tab-click="handleClick" class='el-tabs'>
        ...
        <el-tab-pane label="已约面试" name="first">
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-select v-if='is_editing_id === scope.row.id' size='small' v-model="interviewParams.experience"
                           placeholder="">
                  <el-option v-for="(item, index) in experience" :key='index' :label='item.dictionary_name'
                             :value='item.id'></el-option>
                </el-select>
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-select v-if='is_editing_id === scope.row.id' size='small' v-model="interviewParams.resume_source"
                           placeholder="">
                  <el-option v-for="(item, index) in source" :key='index' :label='item.dictionary_name'
                             :value='item.id'></el-option>
                </el-select>
              </template>
            </el-table-column>
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-button class='font-color' v-if='is_editing_id === scope.row.id' size='mini'
                           @click.stop='cancelEdit'>取消
                </el-button>
                <el-button class='font-color' v-if='is_editing_id === scope.row.id' size='mini'
                           @click.stop='confirmEdit(scope.row)'>确定
                </el-button>
              </template>
            </el-table-column>
            <el-table-column
              ...
              <template slot-scope="scope">
                ...
                <el-select
                  ...
                  placeholder="">
                  <el-option v-for="(item, index) in interview_unfinished" :key='index' :label='item.dictionary_name'
                             :value='item.id'></el-option>
                </el-select>
              </template>
            </el-table-column>
          ...
          <div class='add-interviewer'>
            <el-button class='font-color' size='mini' icon="el-icon-plus" @click='addInterviewerDialog = true'>添加面试人
            </el-button>
          </div>
        </el-tab-pane>
        <el-tab-pane label="面试完毕" name="second">
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <span
                  v-if="scope.row.interviewers && scope.row.interviewers.name">{{scope.row.interviewers.name}}</span>
                <span v-else>/</span>
              </template>
            </el-table-column>
            <el-table-column
          ...
          <div v-if='is_agree == "1"'>
            <el-form-item label="薪资">
              <el-input v-if='is_editing_condition' size='mini'
                        v-model="agreeInductParams.update.entry_other.salary"></el-input>
