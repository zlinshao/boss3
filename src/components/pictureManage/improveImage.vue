  ...
  <div id="improveImgInfo">
    <el-dialog title="上传完成" :visible.sync="improveImgInfoDialogVisible" width="40%">
      <div class="">
        <el-form size="small" :model="formInfo" label-width="100px">
          ...
          <el-row >
            <el-col align="center">
              <span style="margin: 10px auto;display: inline-block;"><strong>统一添加信息</strong> 或<el-button type="text" style="color: #2595B7;" @click="editSingleInfo">编辑单条信息</el-button></span>
            </el-col>
          </el-row>
          <el-row >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button size="small" type="primary" @click="improveImgInfoDialogVisible = false">保存并查看</el-button>
      </span>
    </el-dialog>
    <el-dialog title="编辑图片信息" :visible.sync="editImgInfoDialogVisible" width="40%" >
      <div>
        ...
        <div slot="footer" class="dialog-footer" style="text-align: center">
          <el-button  size="small" type="primary" @click="editImgInfoDialogVisible = false">保存并查看</el-button>
        </div>
      </div>
    </el-dialog>
  </div>
