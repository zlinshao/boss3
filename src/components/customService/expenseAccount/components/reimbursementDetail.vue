                ...
                <el-row>
                  <el-col :span="12">
                    <el-form-item label="水费">
                      <div class="content">
                        <span v-if="reimDetail.results.water_fee.time && reimDetail.results.water_fee.time.length>0">{{reimDetail.results.water_fee.time[0]}}——{{reimDetail.results.water_fee.time[0]}}</span>
                        <span v-else>暂无</span>
                      </div>
                    </el-form-item>
                  </el-col>
