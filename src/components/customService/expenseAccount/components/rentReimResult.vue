          ...
          <el-row>
            <el-col :span="24">
              <el-form-item label="截图">
                <Upload :ID="'rentResult'" @getImg="getResultImage" :editImage="picResultImg" :isClear="isClear"></Upload>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
...
<script>
  ...
  export default {
    props: ['reimResultDialog', 'reimbursementId', 'type'],
