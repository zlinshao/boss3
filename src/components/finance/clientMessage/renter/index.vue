<template>
  <div @click="show=false" @contextmenu="closeMenu">
    ...
    <Renter :module="renterVisible" @close="renterVisible = false"></Renter>

    <RenterDetail :module="detailVisible" @close="detailVisible = false"></RenterDetail>
  </div>
</template>

<script>
  import RightMenu from '../../../common/rightMenu.vue'               //右键
  import Renter from './components/renter.vue'                        //房东
  import RenterDetail from './components/renterDetail.vue'            //房东
  export default {
    name: "index",
    components: {RightMenu, Renter, RenterDetail},
    data() {
      return {
        rightMenuX: 0,
        rightMenuY: 0,
