    ...
    methods: {
      ...
      handleEditOk() {
        if (!this.editValue) {
          ...
          this.$http.post(this.url + `account/allocation/update/${this.currentRow.id}`,{
      ...
      handleEditChange() {
        this.$http.get(this.url + 'account/manage/index',{
          params: {
            cate: this.editCate,
            all: 1
          }
      ...
      getAccountList() {
        ...
        this.$http
          .get(this.url + "account/allocation/index", {
            params: this.params
          })
          .then(res => {
            if (res.data.success) {
      ...
      deleteAccount() {
        this.$http.post(this.url + "account/allocation/delete", {id: this.multipleSelection}).then(res => {
          if (res.data.success) {
            this.$notify.success({
              title: "成功",
      ...
      addAllocation() {
        ...
        this.$http.post(this.url + 'account/allocation/add',this.formAllocation).then(res => {
          if (res.data.success) {
            this.$notify.success({
              title: '成功',
              message: res.data.message
      ...
      // 新增账户人或账户
      addAccountNameOwner() {
        this.$http.post(this.url+ "financial/account_alloc/complement", this.addAccountFrom).then(res => {
