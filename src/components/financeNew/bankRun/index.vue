  ...
  <div id="bankRun">
    ...
    <el-dialog
      ...
      <el-form size="mini" label-width="100px" style="width: 80%;margin: 0 auto">
        ...
        <el-form-item label="账户类型" v-if="params.bank_template == 3 || params.bank_template == 9 || params.bank_template == 11 || params.bank_template == 12">
        ...
        <el-form-item label="选择账户" v-if="params.bank_template == 3 || params.bank_template == 9 || params.bank_template == 11 || params.bank_template == 12">
