    ...
    <el-dialog
      ...
      <div class="scroll_bar">
        <el-form :model="form" size="mini" label-width="88px">
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="出发地">
                <el-input v-model="form.input1" placeholder="请输入">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="目的地">
                <el-input v-model="form.input1" placeholder="">
                </el-input>
              </el-form-item>
            </el-col>
          </el-row>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="总住宿(元):">
                <div>12313123</div>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="总餐饮费(元):">
                <div>12313123</div>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="总餐饮(元):">
                <div>12313123</div>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="总交通费(元):">
                <div>12313123</div>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="12">
              <el-form-item label="总其它费用(元):">
                <div>12313123</div>
              </el-form-item>
            </el-col>
            <el-col :span="12">
              <el-form-item label="总合计(元):">
                <div>12313123</div>
              </el-form-item>
            </el-col>
          </el-row>
      ...
      <span slot="footer">
        <el-button type="primary" @click="chuchaiVisible = false">提交</el-button>
      </span>
    </el-dialog>
  </div>
</template>m
