      ...
      <div class="scroll_bar">
        <el-form :model="form" size="mini" label-width="80px">
          <el-row>
            <el-col :span="8">
              <el-form-item label="姓名">
                <el-input v-model="form.input1" placeholder="请输入姓名">
                </el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
          ...
          <el-form-item label="申请理由">
            <el-input v-model="form.textarea" type="textarea" :autosize="{minRows: 2, maxRows: 4}" placeholder="请填写申请理由"></el-input>
          </el-form-item>
