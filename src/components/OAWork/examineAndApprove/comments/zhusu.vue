<template>
  <div class="modalFrame">
    <el-dialog
      title="住宿申请"
      :visible.sync="quarterVisible"
      width="50%">
      <el-form :model="form" size="mini" label-width="80px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="住宿申请人姓名">
      ...
      <span slot="footer">
        <el-button type="primary" @click="quarterVisible  = false">提交</el-button>
      </span>
    </el-dialog>
  </div>
</template>
