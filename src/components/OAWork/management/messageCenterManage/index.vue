      ...
      openContextMenu(row) {
        ...
        if (row.is_open && !row.is_drop) {
          ...
          this.lists = [
            ...
            {clickIndex: "setOpen", headIcon: "iconfont icon-notpublic", label: "非公开", openStatus: 'close'},
          ...
          this.lists = [
            {clickIndex: "deleteMessageCenter", headIcon: "el-icon-delete", label: "删除"},
            {clickIndex: "setOpen", headIcon: "iconfont icon-public", label: "公开", openStatus: 'open'},
            {clickIndex: "setDrop", headIcon: "iconfont icon-shangjia--", label: "上架", dropStatus: 'undrop'},
          ];
        } else if (!row.is_open && !row.is_drop) {
          //非公开 上架
