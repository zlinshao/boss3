<template>
  <div>
    <el-dialog :close-on-click-modal="false" title="丢失合同详情" :visible.sync="contractCancelDialogVisible">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      getDetail(){
        this.$http.get(globalConfig.server+'contract/loss/'+this.cancelEditId_detail).then((res) => {
