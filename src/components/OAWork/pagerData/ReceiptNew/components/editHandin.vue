            ...
            <el-row>
              ...
              <el-col :span="8">
                <el-form-item label="收据类型">
                  <el-select v-model="params.contract_type" disabled="" placeholder="请选择收据类型">
            ...
            <div v-if="params.contract_type == '109'">
              ...
              <div style="text-align: center">
                <el-button type="text" @click="addMediumNumberCollect">
                  <i class="el-icon-circle-plus"></i>增加中介收据编号(收)
                </el-button>
              </div>
            ...
            <div v-if="params.contract_type == '110'">
              ...
              <div style="text-align: center">
                <el-button type="text" @click="personal_addMediumNumberCollect">
                  <i class="el-icon-circle-plus"></i>增加个人收据编号(收)
                </el-button>
              </div>
      ...
      getApplyDetail(){
        this.$http.get(globalConfig.server+'contract/handin/'+this.handInEditId).then((res) => {
          if(res.data.code === '20010'){
            ...
            if(Number(this.params.contract_type) === 108){    //如果是公司收据
