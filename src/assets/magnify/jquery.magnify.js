...
var $W = $(window),
  ...
  defaults = {
    ...
    icons: {
      maximize: 'el-icons-fa-desktop',
      close: 'el-icon-close',
      zoomIn: 'el-icons-fa-search-plus',
      zoomOut: 'el-icons-fa-search-minus',
      prev: 'el-icons-fa-long-arrow-left',
      next: 'el-icons-fa-long-arrow-right',
      fullscreen: 'el-icons-fa-arrows-alt',
      actualSize: 'el-icon-picture',
      rotateLeft: 'el-icons-fa-rotate-left',
      rotateRight: 'el-icons-fa-rotate-right',
